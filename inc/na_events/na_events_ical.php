<?php
/**
 * @link http://www.noeltock.com/web-design/wordpress/how-to-ical-with-custom-post-types/
 */
function na_events_ical() {
...
<?php
// - full output -
$naeventsical = ob_get_contents();
ob_end_clean();
echo $naeventsical;
}

function add_na_events_ical_feed () {
    // - add it to WP RSS feeds -
    add_feed('na-events-ical', 'na_events_ical');
}

add_action('init','add_na_events_ical_feed');
?>